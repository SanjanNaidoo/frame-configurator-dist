...
function mountConfigurator(host, root) {
  ...
  function wireControls() {
    ...
    $('btn-pay').addEventListener('click', () => sendRequest('checkout-request'));
  }
  ...
  function renderQuote() {
    ...
    // Paying online only appears once the rate card has been checked against
  ...
  const submitQuoteRequest = () => sendRequest('quote-request');

  /**
   * Hands the order to the page, either to be emailed as a quote or taken to
   * checkout. Both carry the same detail; only the event name differs.
   */
